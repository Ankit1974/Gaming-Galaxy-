            ...
            try {
                ...
                for (const doc of playerSnapshot.docs) {
                    ...
                    for (const subDoc of subcollectionSnapshot.docs) {
                        const sensitivityRef = subDoc.ref.collection('Sensitivity').doc('6AgksM2HL4DDkKVSV8sH'); // Replace 'your_document_id_here' with the actual document ID
            ...
            <View style={styles.achievementContainer}>
                {item.achievements.map((achievement, index) => (
                    <View key={index} style={styles.achievementContent}>
                        <Text style={styles.heading}>GYRO SENSITIVITY SETTING</Text>
