            ...
            try {
                ...
                for (const doc of playerSnapshot.docs) {
                    ...
                    for (const subDoc of subcollectionSnapshot.docs) {
                        const sensitivityRef = subDoc.ref.collection('Sensitivity').doc('AXfUbxln7gRR8RS0iIz5'); // Replace 'your_document_id_here' with the actual document ID
