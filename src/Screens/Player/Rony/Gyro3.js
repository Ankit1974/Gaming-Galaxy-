            ...
            try {
                ...
                for (const doc of playerSnapshot.docs) {
                    ...
                    for (const subDoc of subcollectionSnapshot.docs) {
                        const sensitivityRef = subDoc.ref.collection('Sensitivity').doc('Orlsz1BXXqMASA6LcZiS'); // Replace 'your_document_id_here' with the actual document ID
